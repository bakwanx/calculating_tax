...
class CounterBloc extends Bloc<CounterEvent, CounterState> {
  ...
  void onUsingNominalValue(double nominal) {
    ...
    calculateModel.anotherDpp = (calculateModel.dpp! * 11) / 12;
    calculateModel.ppn = 11 / 100 * calculateModel.dpp!.toDouble();
    calculateModel.pph = 2 / 100 * calculateModel.dpp!.toDouble();
    calculateModel.ppnAndpph =
        calculateModel.ppn!.toDouble() + calculateModel.pph!.toDouble();
  ...
  void onUsingTransferValue(double transfer) {
    ...
    print(
      "PPN & PPH ${calculateModel.ppn!.toDouble() + calculateModel.pph!.toDouble()}",
    );
  }
}
